...
Template.add_goal_modal2.onRendered(function (gg) {
...
Template.add_goal_modal2.helpers({
...
Template.goal_modal2.events({
	...
	"click .next": function(event, template){
		...
		if (currentSection<4){
			...
			var priority = event.target.form[15].value;
